...
public class ServiceOrderDetailsEntity {
	...
	private String serviceOrderOpenDate;
	private String serviceOrderCloseDate;
	...
	public String getServiceOrderOpenDate() {
		return serviceOrderOpenDate;
	}
	public void setServiceOrderOpenDate(String serviceOrderOpenDate) {
		this.serviceOrderOpenDate = serviceOrderOpenDate;
	}
	public String getServiceOrderCloseDate() {
		return serviceOrderCloseDate;
	}
	public void setServiceOrderCloseDate(String serviceOrderCloseDate) {
